...
최신 PycURL 릴리즈에 대한 설명서는 `PycURL 웹사이트 <https://pycurl.github.io/docs/latest/>`_ 에서 구할 수 있습니다.

PycURL 개발 버전에 대한 설명서는 `여기 <https://pycurl.github.io/docs/dev/>`_ 에서 볼 수 있습니다.
